    ...
    <>
      ...
      {isMobile && (
        <Flex
          ...
          itemAlign={"center"}
          justify={"between"}
          className="oui-fixed oui-bottom-0 oui-start-0 oui-end-0 oui-pb-[env(safe-area-inset-bottom)]"
        >
